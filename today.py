...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    for element_id, value in [('age_data', age_data), ('commit_data', commit_data), ('star_data', star_data),
                              ('repo_data', repo_data), ('contrib_data', contrib_data),
                              ('follower_data', follower_data), ('loc_data', loc_data[2]),
...
def user_getter(username):
    ...
    if request.json()['data']['user'] is None:
        raise Exception('Failed to get user data: ' + request.text)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 5, 2))
